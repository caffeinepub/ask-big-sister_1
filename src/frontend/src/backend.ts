...
export class Backend implements backendInterface {
    ...
    async clearUserProfile(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearUserProfile();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentWalletAddress(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentWalletAddress();
    ...
    async getWalletAddress(arg0: Principal): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async linkWalletAddress(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.linkWalletAddress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlinkWalletAddress(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlinkWalletAddress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateWalletAddress(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateWalletAddress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        walletAddress: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.walletAddress))
    };
}
