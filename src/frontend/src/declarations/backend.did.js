...
export const idlService = IDL.Service({
  ...
  'getCurrentWalletAddress' : IDL.Func([], [IDL.Opt(IDL.Text)], ['query']),
  ...
  'getWalletAddress' : IDL.Func(
      [IDL.Principal],
      [IDL.Opt(IDL.Text)],
      ['query'],
    ),
  'isCallerAdmin' : IDL.Func([], [IDL.Bool], ['query']),
  'linkWalletAddress' : IDL.Func([IDL.Text], [], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'unlinkWalletAddress' : IDL.Func([], [], []),
  'updateUserProfile' : IDL.Func([IDL.Text], [], []),
  'updateWalletAddress' : IDL.Func([IDL.Text], [], []),
});
